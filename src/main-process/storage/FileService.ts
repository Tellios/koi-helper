...
import type { IFile, IFileBase, IFileReference } from '@shared/models';
...
export class FileService {
  ...
  @LogFunction()
  public async add(entityManager: EntityManager, file: IFileBase): Promise<IFileReference> {
    const repository = entityManager.getRepository(FileEntity);
  ...
  public async update(
    ...
    const entity = await repository.findOneByOrFail({ id: fileId });
    entity.data = data;
