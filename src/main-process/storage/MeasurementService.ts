...
import type { IMeasurement, IMeasurementBase } from '@shared/models';
...
export class MeasurementService {
  ...
  @LogFunction()
  public async getMeasurements(entityManager: EntityManager, fishId: Id): Promise<IMeasurement[]> {
  ...
  public async add(
    ...
    newMeasurement.fish = await fishRepository.findOneByOrFail({ id: fish });
  ...
  public async update(
    ...
    const entity = await repository.findOneByOrFail({ id: measurement.id });
  ...
  @LogFunction()
  public async delete(entityManager: EntityManager, measurementId: Id): Promise<void> {
